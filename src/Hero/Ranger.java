...
public class Ranger extends Hero {
    ...
    public Ranger(String name) {
        ...
        this.primaryAttribute = new PrimaryAttribute(1, 7, 1);
    ...
    public void getWeapon(String weapon) throws InvalidWeaponException {
        ...
        } else if (!(this.weapon.checkTypeWeapon(weapon, "ranger"))) {
            throw new InvalidWeaponException("This weapon is not available for rangers."); // checks if current character can equip this weapon
    ...
    public void getArmor(String armor, String slot) throws InvalidArmorException {
        ...
        } else if (!(this.armor.checkTypeArmor(armor, "ranger"))) {
            throw new InvalidArmorException("This armor is not available for rangers."); // checks if current character can equip this armor
